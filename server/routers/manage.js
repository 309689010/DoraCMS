...
router.get(
  '/adminResource/getList',
  authToken,
  authPower,
  AdminResource.getAdminResources
)

router.post(
  '/adminResource/addOne',
  authToken,
  authPower,
  AdminResource.addAdminResource
)

router.post(
  '/adminResource/updateOne',
  authToken,
  authPower,
  AdminResource.updateAdminResource
)

router.get(
  '/adminResource/deleteResource',
  authToken,
  authPower,
  AdminResource.delAdminResource
)
...
router.get(
  '/contentCategory/deleteCategory',
  authToken,
  authPower,
...
router.post(
  '/contentTag/updateOne',
  authToken,
  authPower,
  ContentTag.updateContentTag
)

router.get(
  '/contentTag/deleteTag',
  authToken,
  authPower,
  ContentTag.delContentTag
)
...
// 获取备份数据列表
router.get(
  '/backupDataManage/getBakList',
  authToken,
  authPower,
  DataOptionLog.getDataBakList
)

// 备份数据库执行
router.post(
  '/backupDataManage/backUp',
  authToken,
  authPower,
  DataOptionLog.backUpData
)

// 删除备份数据
router.get(
  '/backupDataManage/deleteDataItem',
  authToken,
  authPower,
  DataOptionLog.delDataItem
)
...
router.get(
  '/systemOptionLog/getList',
  authToken,
  authPower,
  SystemOptionLog.getSystemOptionLogs
)

// 删除操作日志
router.get(
  '/systemOptionLog/deleteLogItem',
  authToken,
  authPower,
...
// 清空日志
router.get(
  '/systemOptionLog/deleteAllLogItem',
  authToken,
  authPower,
  (req, res, next) => {
    req.query.ids = 'all'
...
// 删除操作日志
router.get(
  '/systemNotify/deleteNotifyItem',
  authToken,
  authPower,
  UserNotify.delUserNotify
)

// 设为已读消息
router.get(
  '/systemNotify/setHasRead',
  authToken,
  authPower,
  (req, res, next) => {
    req.query.systemUser = req.session.adminUserInfo._id
...
// 发布系统公告
router.post(
  '/systemAnnounce/addOne',
  authToken,
  authPower,
  Notify.addOneSysNotify
)
/**
 * 广告管理
 */
...
// 获取模板文件列表
router.get(
  '/template/getTemplateForderList',
  authToken,
  authPower,
  ContentTemplate.getContentDefaultTemplate
)

// 读取文件内容
router.get(
  '/template/getTemplateFileText',
  authToken,
  authPower,
  ContentTemplate.getFileInfo
)

// 更新文件内容
router.post(
  '/template/updateTemplateFileText',
  authToken,
  authPower,
  ContentTemplate.updateFileInfo
)

// 获取已安装的模板列表
router.get(
  '/template/getMyTemplateList',
  authToken,
  authPower,
  ContentTemplate.getMyTemplateList
)
...
router.post(
  ...
  authToken,
  authPower,
  ContentTemplate.addTemplateItem
)

// 删除模板单元
router.get(
  '/template/delTemplateItem',
  authToken,
  authPower,
  ContentTemplate.delTemplateItem
)

// 获取默认模板的模板单元列表
router.get(
  '/template/getTemplateItemlist',
  authToken,
  authPower,
  ContentTemplate.getTempItemForderList
)
...
router.get(
  ...
  authToken,
  authPower,
  ContentTemplate.getTempsFromShop
)

// 安装模板
router.get(
  '/template/installTemp',
  authToken,
  authPower,
  ContentTemplate.installTemp
)
...
router.get(
  ...
  authToken,
  authPower,
  ContentTemplate.enableTemp
)

// 卸载模板
router.get(
  '/template/uninstallTemp',
  authToken,
  authPower,
  ContentTemplate.uninstallTemp
)
